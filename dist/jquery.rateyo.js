(function () {
  ...
  function RateYo(node) {
    ...
    var that = this;
    this.node = node;
    var $node = $(node); // Remove any stuff that is present inside the container, and add the plugin class
  ...
  (function ($$1) {
    ...
    var eventsTrigger = $.El.prototype.trigger;

    $.El.prototype.trigger = function overrideTrigger() {
      var _$;
    ...
    function _rateYo(options) {
      ...
      return $$1.each($nodes, function () {
        ...
        var $node = $$1(this),
            dataAttrs = {},
            optionsCopy = $$1.extend({}, options);
        $$1.each($node.data(), function (key, value) {
        ...
        return new RateYo(this, $$1.extend({}, dataAttrs, optionsCopy));
      });
    }
